    ...
    <div class='wrapper'>
      <div>
        <div class='bloque_info'>
          <h1>Desafíos</h1>
          <p class='highlights01' style='width:100%; top:0;'>Los desafíos que enfrenta Colombia son muy grandes. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Officia esse saepe illo sequi dolorem porro nihil quod distinctio consectetur. Optio quaerat deleniti numquam ea harum, rem voluptate nulla ad voluptates?. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Fuga adipisci saepe soluta voluptates hic cumque, placeat quam quas excepturi voluptatibus totam minus, earum est molestias! Totam neque error omnis suscipit.</p>
        </div>
        <div class='bloque_info' style="margin-bottom: 0">
          <h1>Desafíos recientes</h1>
        </div>
        <?php if($posts){ ?>
        <ul id='panel_academia' style="position:relative;top:-60px">
          <?php foreach ($posts as $p): ?>
          <li>
            <a href="<?php echo site_url('desafios/post'); ?>/<?= $p->p_id ; ?>">
