          ...
          <ul class="sidebar-menu">
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('dosmil/posts'); ?>">Listado de Posts</a></li>
                <li><a href="<?php echo site_url('dosmil/posts/add'); ?>">Crear Post</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="<?php echo site_url('desafios/posts'); ?>">Listado de Posts</a></li>
                <li><a href="<?php echo site_url('desafios/posts/add'); ?>">Crear Post</a></li>
            ...
            <li><a href="#"><i class="fa fa-circle-o text-aqua"></i> <span>Cerrar Sesión</span></a></li>
          </ul><!-- /.sidebar-menu -->
        </section>
        <!-- /.sidebar -->
      </aside>