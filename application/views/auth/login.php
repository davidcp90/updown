       ...
       <div class="row">
        ...
        <div class="col-md-4 col-md-offset-4 col-sm-6 col-sm-offset-3  well">
            ...
            <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="identity" value="" id="identity" placeholder="Email">
            </div>
            <div class="input-group">
                <span class="input-group-addon">
            ...
            <div class="checkbox">
                  <label>
                    <input type="checkbox" name="remember" value="1" id="remember"/> Recordar en este equipo
                  </label>
            </div>
